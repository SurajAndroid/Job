 ...
 */
public class SearchCandidateAdapter extends BaseAdapter {
    ...
    public SearchCandidateAdapter(Context context, Activity activity, ArrayList<CandidateDTO> candidateList){
