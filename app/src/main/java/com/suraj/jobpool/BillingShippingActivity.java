...
import dtos.CardTypeDTO;
import dtos.EMIOptionDTO;
import dtos.PaymentOptionDTO;
...
public class BillingShippingActivity extends Activity {
    ...
    private class GetData extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            String vJsonStr = sh.makeServiceCall(Constant.JSON_URL, ServiceHandler.POST, vParams);
